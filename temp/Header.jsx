...
const Header = () => {
  ...
  return (
    <div className='relative z-[999] w-full flex items-center justify-between h-[60px]  px-[3.5vw] py-2 font-NeueMontreal'>
        {/* left */}
        ...
        {/* center */}
        {
          ...
          {[
            ...
            { name: "Recent Work", path: "/work" ,target:""},
            ...
            <nav className="flex flex-col lg:hidden gap-5 h-[100vh] w-[100vw] bg-black text-white absolute">
          {[
            { name: "Blog", path: "https://oneminutestech.com/" ,target:"_blanck"},
            { name: "Recent Work", path: "/work" ,target:""},
            { name: "About us", path: "/about",target:"" },
        ...
        {/* right */}
        <div className="right lg:hidden sm:rounded-[50%]">
        {
          !menuOpen?              
                <div >
                <svg className='hidden lg:block' xmlns="http://www.w3.org/2000/svg"  onClick={menuHandler} height="40px" viewBox="0 -960 960 960" width="40px" fill="#FFFFFF"><path d="M160-380v-66.67h640V-380H160Zm0-133.33V-580h640v66.67H160Z"/></svg>
                <svg className='' xmlns="http://www.w3.org/2000/svg"  onClick={menuHandler} height="40px" viewBox="0 -960 960 960" width="40px" fill="#000000"><path d="M160-380v-66.67h640V-380H160Zm0-133.33V-580h640v66.67H160Z"/></svg>
                 </div>
               :
               <svg xmlns="http://www.w3.org/2000/svg"  onClick={menuHandler} height="40px" viewBox="0 -960 960 960" width="40px" fill="#FFFFFF"><path d="m251.33-204.67-46.66-46.66L433.33-480 204.67-708.67l46.66-46.66L480-526.67l228.67-228.66 46.66 46.66L526.67-480l228.66 228.67-46.66 46.66L480-433.33 251.33-204.67Z"/></svg>
        }
        </div>
